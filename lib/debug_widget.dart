...
class _DebugWidget extends StatefulWidget {
  ...
  Map<String, String> _debugExperiments;
  Map<String, String> _experiments;
  Function(bool loaded) _optionsLoadedSetter;
  Function _experimentsOptionsLoader;
  DebugCallback _valuesChangedCallback;
                ...
                children: [
                  ...
                  ExpansionPanelList(
                    ...
                    children: widget._experimentsOptions
                      ...
                      final selectedOption = widget._debugExperiments[key] ??
                      ...
                      return ExpansionPanel(
                        ...
                        isExpanded: _expanded.asMap()[widget._experimentsOptions
                                .indexOf(experiment)] ??
                            false,
                      );
                    }).toList(),
